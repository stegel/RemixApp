...
function getViewFromPath(
  ...
  if (
    ...
    cleanPath.endsWith("/registration")
  )
    return "registration";
  if (cleanPath === "/admin" || cleanPath.endsWith("/admin"))
    return "admin";
  if (cleanPath === "/form" || cleanPath.endsWith("/form"))
    return "form";
  return "form"; // default to form for '/' and other paths
}

function getPathFromView(
  view: "form" | "registration" | "admin",
): string {
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center space-y-4 mb-6">
            ...
            <div className="text-center">
              ...
              >
                Please make sure to judge every presentation you
                hear. We want each team to have at least 3
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
            <Button
              ...
              variant={
                activeView === "form" ? "default" : "outline"
              }
              className={
                activeView === "form"
              ...
              disabled={
                !dbStatus.tablesExist && !dbStatusLoading
              }
            >
              Submit Evaluation
            </Button>
            ...
            <Button
              ...
              variant={
                activeView === "admin" ? "default" : "outline"
              }
              className={
                activeView === "admin"
                  ? "bg-primary text-primary-foreground"
